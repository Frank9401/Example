...
class Account {
    ...
    withdrawMoney(amount) {
        if(this.#amount > amount){
            ...
            console.log(`Sizning balansizngizdagi pul yetarli emas: ${this.#amount}$`);
        }
    ...
    makeDeposit(amount) {
        this.#amount += amount;
        console.log(`Hisobingiz tuldirildi, hisobingiz ${this.#amount}$ tashkil etdi`);
    }
    ...
    static tellMeAboutClass(){
        console.log('Bu class accounlarni yasash uchun hizmat qiladi');
    }
